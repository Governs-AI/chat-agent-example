...
export default function Dashboard() {
  ...
  const getPrecheckUrl = (userId: string, apiKey: string) => {
    const baseUrl =
      process.env.NEXT_PUBLIC_PRECHECK_URL || "http://localhost:8080";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={
                  process.env.NEXT_PUBLIC_PRECHECK_URL ||
                  "http://localhost:8080"
                }
                disabled
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-6">
          ...
          <div className="text-sm text-blue-800 space-y-2">
            ...
            <p>
              2. <strong>Copy the URL:</strong> Use the generated precheck URL
              in your applications
            </p>
            <p>
              3. <strong>Test the integration:</strong> Use the demo chat with
              your user ID and API key
            </p>
            <p>
              4. <strong>Manage keys:</strong> Deactivate or delete keys as
              needed for security
            </p>
          </div>
        </div>
